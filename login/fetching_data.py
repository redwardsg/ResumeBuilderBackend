...
def contact_information():
    ...
    if request.method == 'GET':
        ...
        contact={
        'alternate_email': var_2[1],
        'phone_number': var_2[2],
        'alternate_number': var_2[3],
        'address': var_2[4],
        'linkedin_url': var_2[5]
        }
        ...
        for project in var_5:
            ...
            project1.append({'project_name':project_name
        ...
        for certificate in var_6:
            ...
            certificate1.append({'certification_name':certification_name
                       ,'issued_by':issued_by
